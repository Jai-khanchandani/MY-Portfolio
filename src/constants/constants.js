export const projects = [
  {
    ...
    description: "Developed a web application for tracking the Covid-19 cases all over the world. Users can also apply filters on the data and get the desired results",
      ...
      tags: ['ReactJS', 'Axios', 'React-Hooks'],
...
export const experience = [
  {
    ...
    description: "Working as Associate Front-end Engineer majorly Doing in JavaScript and ReactJs. And Learning new things daily which is helping me to grow as a good software developer. Also doing hands on NodeJs.",
      image: '/images/exp1.png',
      tags: ['ReactJS', 'JavaScript', 'React-Redux'],
    source: 'https://github.com/Jai-khanchandani/covid-19-tracker',
    visit: 'https://numbers-covid19.netlify.app/',
    id: 0,
  },
  {
    title: 'Technoglobe',
    description:"Done Training in Back-End development with Django and Python. During Training worked on the project ”Volia” which helped me to understand the backend workflow.",
